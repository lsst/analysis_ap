...
# like this already live in analysis_tools?
...
# TODO: At least update the interface to take an instantiated butler.
# TODO: This could be made by a visit-level (nightly?) afterburner as part of
# every run.
...
# TODO: this is entirely generic, and should either go away or lifted to afw?
...
# TODO: At least update the interface to take an instantiated butler, and no
# instrument.
...
# TODO: At least update the interface to take an instantiated butler.
# TODO: Make this from a per-detector/[visit?] number of diaSources afterburner output.
...
# TODO: HITS specific: replaced with HitsDiaPlot?
...
# TODO: Redo this to use ccdVisitProcessing.seeing.
# TODO: This is generic and should live in analysis_tools (does it?).
...
# TODO: At least update the interface to take an instantiated butler.
# TODO: This could be generated by a visit-level afterburner.
...
# TODO: we should have a generic location to store our canonical bad flag list.
...
# TODO: This is generic: we should be using a flux plot from analysis_tools.
...
# TODO: This is generic: we should be using a magnitude plot from analysis_tools.
...
# TODO: replace with plotDifferenceImageCutouts.
