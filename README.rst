...
The focus of this package is human-driven analysis of DiaSources and DiaObjects written to the PPDB/APDB; for automatic metric and plot generation on butler outputs during processing runs, see XXXX in `analysis_tools <https://github.com/lsst/analysis_tools>`_.
